...
The representation will be a 2d array of booleans, which will be the grid.
To restrict the grid, the 2d array must have a row and column length > 0. To
intepret the grid, a true value represents that cell being a live, which false
means it is dead.
